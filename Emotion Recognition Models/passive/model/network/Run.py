...
model = EmotionCNN()
model.load_state_dict(torch.load("emotion_cnn.pth")) #name of model
...
#You will need a researcher account setup, from Auckland Bioengineering Institute Dr. Derek Orbaugh. User ID will also need to be set up and is for the account connected to the watch.
email = ""
password = ""
user_id = "11"
...
def hash_ppg(ppg_list):
    # need hash because sometimes the api returns duplicates of the same timestamp

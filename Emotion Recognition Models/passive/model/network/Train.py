...
#The DEAP dataset .dat files were placed in the /data folder, except the left out participant placed in the /leaveOneOut folder.
dataFolder = './data'
...
#train test split stratified on both
